...
const SearchBar = () => {
  ...
  return (
    <div className="w-[712px] h-[54px] rounded-xl border border-neutral-500 flex items-center justify-around mt-14 mx-auto">
      <div>
        <select
          value={location}
          onChange={changeLocation}
          className="w-40 text-lg bg-transparent outline-none cursor-pointer text-slate-700"
        >
      ...
      <div>
        <select className="w-40 text-lg bg-transparent outline-none cursor-pointer text-slate-700">
          <option value="" className="">
            Category
          </option>
